...
const About = () => {
  ...
  return (
    <div className={`App ${darkMode ? "dark-mode" : ""}`} onClick={closePopups}>
      <Navbar/>
        ...
        <div className="team-visual">
          <div className="diamond-grid">
            <div className="diamond">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTy8C57fRF8iS8POb5Le_M2XKhPDKBZ8xwNow&s"
                alt="Aldiyar"
              />
            </div>
            <div className="diamond">
